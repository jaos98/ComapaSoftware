...
namespace ComapaSoftware.Modelo
{
    ...
    internal class ControladorPlantas : Conexion
    {
        ...
        public List<ModeloPlantas> GetUpdateInfo(string idReceiver)
        {
            ...
            try
            {
                ...
                while (Consultar.Read())
                {
                    list.Add(new ModeloPlantas(Consultar.GetString(0), Consultar.GetString(1)
